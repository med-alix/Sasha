# File: shallow_sa/model/water_iops/tsm_registry.py
...
class FunctionRegistry:
    def __init__(self):
        ...
        self._required_functions = [
            "bricaud_anap_model",
            "log_bricaud_anap_model",
            "bricaud_bp_model",
            "log_bricaud_bp_model"
        ]

    def load_functions(self, backend: Backend):
        module = import_module_by_backend(backend, ModelName.TSM)
...
FUNCTION_REGISTRY_TSM_ANAP = {
    "bricaud": {
        "model": create_model_function("bricaud_anap_model"),
    },
    "log_bricaud": {
        "model": create_model_function("log_bricaud_anap_model"),
    },
}

FUNCTION_REGISTRY_TSM_BP = {
    "bricaud": {
        "model": create_model_function("bricaud_bp_model"),
    },
    "log_bricaud": {
        "model": create_model_function("log_bricaud_bp_model"),
    },
}

# Usage remains the same:
# from shallow_sa.model.water_iops.tsm_registry import FUNCTION_REGISTRY_TSM_ANAP, FUNCTION_REGISTRY_TSM_BP